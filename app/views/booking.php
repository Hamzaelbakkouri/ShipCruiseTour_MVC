...
<div class="select_div" style="width: 100% !important;">
    <form class="flex justify-center gap-3" action="<?= URLROOT ?>cruiseController/filtre" method="post">
        ...
        <div class="relative inline-flex">
            ...
            <select id="search" class="border border-gray-300 rounded text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none" name="startPort">
        ...
        <input id="done" class="text-white text-lg ml-5 cursor-pointer" type="submit" value="search">
    </form>

    <script>
        var search = document.getElementById('search');
        var products = document.querySelectorAll('#boxPaginat');
        var productsName = document.querySelectorAll('#shipname');
                    ...
                    <div class="block max-w-sm rounded-lg bg-white shadow-lg dark:bg-neutral-700">
                        ...
                        <div class="px-5 pb-5">
                            ...
                            <div class="flex items-center mt-2.5 mb-5">
                                <span id="shipname" class="text-white text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:white ml-3">start port : <?= $cards->start_port ?></span>
